...
export const icons = {
  ...
  github:
    '<path d="M12 2.8a9.2 9.2 0 0 0-2.9 17.9c.46.08.63-.2.63-.45v-1.58c-2.56.56-3.1-1.08-3.1-1.08-.42-1.06-1.02-1.34-1.02-1.34-.84-.58.06-.57.06-.57.93.07 1.42.96 1.42.96.83 1.41 2.17 1 2.7.77.08-.6.32-1 .58-1.23-2.04-.23-4.19-1.02-4.19-4.55 0-1 .36-1.83.95-2.47-.1-.23-.41-1.17.09-2.44 0 0 .78-.25 2.54.94a8.8 8.8 0 0 1 4.62 0c1.76-1.19 2.53-.94 2.53-.94.51 1.27.19 2.21.09 2.44.6.64.95 1.46.95 2.47 0 3.54-2.15 4.31-4.2 4.54.33.29.62.85.62 1.71v2.54c0 .25.17.54.64.45A9.2 9.2 0 0 0 12 2.8Z"/>',
  instagram:
